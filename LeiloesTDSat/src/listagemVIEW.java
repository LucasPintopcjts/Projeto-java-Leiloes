...
public final class listagemVIEW extends javax.swing.JFrame {
    ...
    for (int i = 0; i < produtos.size(); i++) {
        ...
        dados[i][2] = produtos.get(i).getValor();
        dados[i][3] = produtos.get(i).getStatus();
    }
    ...
    try (Connection conn = DriverManager.getConnection(url, usuario, senha);
        ...
        while (rs.next()) {
            ...
            produto.setId(rs.getInt("id"));  // Corrigido para getInt
            produto.setNome(rs.getString("nome"));
            produto.setValor(rs.getInt("valor")); // Adicionando o valor
